...
lbl_recipeList.grid(row = 0, column = colNumRecipes, columnspan = 1)
btn_saveRecipe.grid(row = 0, column = colNumRecipes+1, columnspan = 1)
btn_saveRecipeAs.grid(row = 0, column = colNumRecipes+2, columnspan = 1)
btn_deleteRecipe.grid(row = 0, column = colNumRecipes+3, columnspan = 1)
